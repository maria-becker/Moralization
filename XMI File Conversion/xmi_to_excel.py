...
def write_excel_count(sourcepath, goalpath):
    ...
    worksheet.write(0, 2, "# Obj. Moralwerte", header_format)
    worksheet.write(0, 3, "Label Obj. Moralwerte", header_format)
    worksheet.write(0, 4, "Spans Obj. Moralwerte", header_format)
    worksheet.write(0, 5, "# Sub. Moralwerte", header_format)
    worksheet.write(0, 6, "Label Subj. Moralwerte", header_format)
    worksheet.write(0, 7, "Spans Subj. Moralwerte", header_format)
...
def write_excel_minimal(sourcepath, goalpath):
    ...
    worksheet.write(0, 0, "Text", header_format)
    worksheet.write(0, 1, "Typ", header_format)
    worksheet.write(0, 2, "Label Obj. Moralwerte", header_format)
    worksheet.write(0, 3, "Spans Obj. Moralwerte", header_format)
    worksheet.write(0, 4, "Label Subj. Moralwerte", header_format)
    worksheet.write(0, 5, "Spans Subj. Moralwerte", header_format)
